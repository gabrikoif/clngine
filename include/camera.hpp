...
public:
  ...
  Camera(float p_speed = 4.0f, glm::vec3 p_pos = glm::vec3(0.0f, 2.0f, 0.0f),
         glm::vec3 p_dir = glm::vec3(0.0f, 0.0f, -1.0f), float p_fov = 100.0f,
  ...
  // const means these functions promise not to alter cameraPos, yaw, pitch,
  // etc.
